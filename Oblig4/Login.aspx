...
<body style="height: 295px">
    ...
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="brukernavnTekstBox" runat="server" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBox1" ErrorMessage="Must be length 3-10, can contain capital letters, letters and numbers" ForeColor="Red" ValidationExpression="^[A-Za-z0-9]{3,10}$"></asp:RegularExpressionValidator>
        <p>
